...
export const navigationGroups: Array<{ label: string; icon: React.FC<{ className?: string }>; items: NavItem[] }> = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/trespass-notices', icon: ShieldAlert, label: 'Trespass Notices', roles: ['admin', 'admin_officer', 'master'] },
      { path: '/access-permissions', icon: Lock, label: 'Access Permissions', roles: ['admin', 'admin_officer', 'master'] },
