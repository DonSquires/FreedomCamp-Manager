...
export function BugReportModal({ open, onClose, onSubmit, currentPage }: BugReportModalProps) {
  ...
  const inputCls = 'w-full rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-[#1E1E1E] px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500'
