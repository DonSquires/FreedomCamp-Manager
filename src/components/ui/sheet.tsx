...
function hasSheetTitle(children: React.ReactNode): boolean {
  ...
  React.Children.forEach(children, (child) => {
    ...
    if (childType === SheetPrimitive.Title || displayName.includes("SheetTitle") || displayName.includes("DialogTitle")) {
      found = true
      return
    }

    if (child.props?.children) {
      if (hasSheetTitle(child.props.children)) {
        found = true
      }
    }
  })
...
>(({ side = "right", className, children, ...props }, ref) => {
  const titlePresent = hasSheetTitle(children)
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        {...props}
      >
        {!titlePresent && <SheetPrimitive.Title className="sr-only">Sheet</SheetPrimitive.Title>}
        {children}
