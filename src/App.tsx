    ...
    <QueryClientProvider client={queryClient}>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/contractor-document-log" element={<ProtectedRoute><RoleRoute allowedRoles={['admin', 'admin_officer', 'master']}><ContractorDocumentLog /></RoleRoute></ProtectedRoute>} />
