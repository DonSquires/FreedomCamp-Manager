...
const en: PublicTranslations = {
  ...
  zm: {
    ...
    footerData: 'Data provided by Field Compliance Manager · Freedom Camping Act 2011 applies',
...
const mi: PublicTranslations = {
  ...
  zm: {
    ...
    footerData: 'Raraunga nā Field Compliance Manager · Ka ārahina e te Ture Noho Haumaru 2011',
...
const zh: PublicTranslations = {
  ...
  zm: {
    ...
    viewBylaw: '查看法规',
    viewOnMaps: '在谷歌地图上查看',
    footerData: '数据由 Field Compliance Manager 提供 · 《2011年自由露营法》适用',
    footerNoise: '投诉噪音问题',
...
const hi: PublicTranslations = {
  ...
  zm: {
    ...
    footerData: 'डेटा Field Compliance Manager द्वारा प्रदान · स्वतंत्र कैम्पिंग अधिनियम 2011 लागू',
