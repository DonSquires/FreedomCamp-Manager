...
export function ComplianceRecalculation() {
  ...
  const handleRunRecalculation = async () => {
    ...
    try {
      ...
      console.log(`📦 Processing ${totalObservations} observations in ${batches} batches of 50`);
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Frontend-driven batching - processes 50 records at a time with live progress
          </p>
        </div>
          ...
          <CardContent className="space-y-6">
            ...
            <Alert>
              ...
              <AlertDescription className="text-sm">
                ...
                updates monthly stays, creates breach alerts. Processing 50 records per batch.
              </AlertDescription>
            </Alert>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-center text-muted-foreground">
                  Batch {currentBatch} of {totalBatches} • 50 records per batch
                </p>
              </div>
