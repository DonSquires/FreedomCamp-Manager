...
import { Camera, Map, FileText, History, AlertTriangle, MapPin, QrCode, ShieldAlert, CheckCircle, Shield, Megaphone, FileWarning, XCircle, Home, X } from 'lucide-react'
...
export default function FieldOfficerPortal() {
  ...
  // ── Scan pipeline placeholder ─────────────────────────────────────────────
  // TODO: Rebuild scan pipeline from scratch.
  const handleCapture = (_file: File) => {
    toast.info('Scan pipeline is being rebuilt. Please check back soon.')
  }
      ...
      {showScanner ? (
        ...
        <>
          ...
          <Card className="hover:shadow-lg transition-shadow border-blue-200 dark:border-blue-900 border-2">
            ...
            <CardContent>
              <Button className="w-full h-12 text-lg" onClick={handleStartScanner}>
                Open Scanner
              </Button>
            </CardContent>
          </Card>
