...
type PersonOfInterest = Database['public']['Tables']['persons_of_interest']['Row']
      ...
      <div className="p-6 space-y-6">
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center py-12 text-muted-foreground gap-2">
            <AlertCircle className="h-8 w-8" /><p>No persons of interest found</p>
          </div>
        ) : (
