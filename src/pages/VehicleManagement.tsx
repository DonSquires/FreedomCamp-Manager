...
import { Search, Filter, Car, AlertTriangle, CheckCircle, XCircle, Download } from 'lucide-react'
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                {zoneName || 'All Zones'} • {organizationId ? 'Filtered by Organization' : 'All Organizations'}
              </p>
            </div>
                ...
                <CardContent>
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="font-medium">{vehicle.enforcement_count}</span>
                    </div>
