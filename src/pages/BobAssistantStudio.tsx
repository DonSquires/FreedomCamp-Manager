...
import { BrainCircuit, Camera, CheckCircle2, ChevronDown, ClipboardList, Copy, FlaskConical, Loader2, MapPinned, Mic, MicOff, Paintbrush2, Play, Plus, Radio, Route, Send, Volume2, VolumeX, Wrench, ShieldAlert, PhoneOff, SignalHigh, Stethoscope, XCircle } from 'lucide-react'
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex gap-2">
                ...
                >
                  <Wrench className="h-4 w-4 mr-1" /> Copy for GitHub/Copilot
                </Button>
              </div>
