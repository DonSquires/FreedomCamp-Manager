...
function normalizeAgenticCredentialEnv() {
  ...
  setIfMissingChain('PLAYWRIGHT_MASTER_EMAIL', ['TEST_LOGIN_MASTER_EMAIL', 'TEST_MASTER_EMAIL'])
  setIfMissingChain('PLAYWRIGHT_MASTER_PASSWORD', ['TEST_LOGIN_MASTER_PASSWORD', 'TEST_MASTER_PASSWORD'])
  setIfMissingChain('PLAYWRIGHT_ADMIN_ORG1_EMAIL', ['TEST_LOGIN_ADMIN_ORG1_EMAIL', 'TEST_ADMIN_ORG1_EMAIL', 'TEST_ADMIN_EMAIL', 'PLAYWRIGHT_ADMIN_EMAIL'])
  setIfMissingChain('PLAYWRIGHT_ADMIN_ORG1_PASSWORD', ['TEST_LOGIN_ADMIN_ORG1_PASSWORD', 'TEST_ADMIN_ORG1_PASSWORD', 'TEST_ADMIN_PASSWORD', 'TEST_ADMIN_PASWORD', 'PLAYWRIGHT_ADMIN_PASSWORD'])
  setIfMissingChain('PLAYWRIGHT_ADMIN_ORG2_EMAIL', ['TEST_LOGIN_ADMIN_ORG2_EMAIL', 'TEST_ADMIN_ORG2_EMAIL', 'TEST_CLIENT_EMAIL'])
  setIfMissingChain('PLAYWRIGHT_ADMIN_ORG2_PASSWORD', ['TEST_LOGIN_ADMIN_ORG2_PASSWORD', 'TEST_ADMIN_ORG2_PASSWORD', 'TEST_CLIENT_PASSWORD'])
  setIfMissingChain('PLAYWRIGHT_OFFICER_ORG1_EMAIL', ['TEST_LOGIN_OFFICER_ORG1_EMAIL', 'TEST_OFFICER_ORG1_EMAIL', 'TEST_OFFICER_EMAIL'])
  setIfMissingChain('PLAYWRIGHT_OFFICER_ORG1_PASSWORD', ['TEST_LOGIN_OFFICER_ORG1_PASSWORD', 'TEST_OFFICER_ORG1_PASSWORD', 'TEST_OFFICER_PASSWORD'])
  setIfMissingChain('PLAYWRIGHT_CLIENT_VIEWER_EMAIL', ['TEST_LOGIN_CLIENT_VIEWER_EMAIL', 'TEST_CLIENT_VIEWER_EMAIL', 'TEST_CLIENT_EMAIL', 'PLAYWRIGHT_CLIENT_EMAIL'])
  setIfMissingChain('PLAYWRIGHT_CLIENT_VIEWER_PASSWORD', ['TEST_LOGIN_CLIENT_VIEWER_PASSWORD', 'TEST_CLIENT_VIEWER_PASSWORD', 'TEST_CLIENT_PASSWORD', 'PLAYWRIGHT_CLIENT_PASSWORD'])
  setIfMissingChain('PLAYWRIGHT_CLIENT_STAFF_EMAIL', ['TEST_LOGIN_CLIENT_STAFF_EMAIL', 'TEST_CLIENT_STAFF_EMAIL', 'TEST_CLIENT_OFFICER_EMAIL', 'PLAYWRIGHT_CLIENT_OFFICER_EMAIL'])
  setIfMissingChain('PLAYWRIGHT_CLIENT_STAFF_PASSWORD', ['TEST_LOGIN_CLIENT_STAFF_PASSWORD', 'TEST_CLIENT_STAFF_PASSWORD', 'TEST_CLIENT_OFFICER_PASSWORD', 'PLAYWRIGHT_CLIENT_OFFICER_PASSWORD'])
  ...
  setIfMissingChain('PLAYWRIGHT_TEST_ORG_NAME', ['TEST_ORG_NAME', 'TEST_ORGANIZATION_NAME', 'E2E_TEST_ORG_NAME', 'PLAYWRIGHT_DEFAULT_TEST_ORG_NAME'])
  if (!process.env.PLAYWRIGHT_TEST_ORG_NAME) {
    process.env.PLAYWRIGHT_TEST_ORG_NAME = 'Iron Eagle Security Limited'
  }
  setIfMissing('PLAYWRIGHT_ADMIN_ORG1_NAME', 'PLAYWRIGHT_TEST_ORG_NAME')
  setIfMissing('PLAYWRIGHT_ADMIN_ORG2_NAME', 'PLAYWRIGHT_TEST_ORG_NAME')
  setIfMissing('PLAYWRIGHT_OFFICER_ORG1_NAME', 'PLAYWRIGHT_TEST_ORG_NAME')
  setIfMissing('PLAYWRIGHT_CLIENT_VIEWER_NAME', 'PLAYWRIGHT_TEST_ORG_NAME')
  setIfMissing('PLAYWRIGHT_CLIENT_STAFF_NAME', 'PLAYWRIGHT_TEST_ORG_NAME')
  setIfMissing('BOB_LOGIN_ORG_NAME', 'PLAYWRIGHT_TEST_ORG_NAME')
}
