...
set_if_missing_chain PLAYWRIGHT_ADMIN_ORG2_EMAIL TEST_LOGIN_ADMIN_ORG2_EMAIL TEST_ADMIN_ORG2_EMAIL TEST_CLIENT_EMAIL
set_if_missing_chain PLAYWRIGHT_ADMIN_ORG2_PASSWORD TEST_LOGIN_ADMIN_ORG2_PASSWORD TEST_ADMIN_ORG2_PASSWORD TEST_CLIENT_PASSWORD
...
set_if_missing_chain PLAYWRIGHT_CLIENT_STAFF_EMAIL TEST_LOGIN_CLIENT_STAFF_EMAIL TEST_CLIENT_STAFF_EMAIL TEST_CLIENT_OFFICER_EMAIL
set_if_missing_chain PLAYWRIGHT_CLIENT_STAFF_PASSWORD TEST_LOGIN_CLIENT_STAFF_PASSWORD TEST_CLIENT_STAFF_PASSWORD TEST_CLIENT_OFFICER_PASSWORD
...
set_if_missing_chain PLAYWRIGHT_BOB_EMAIL BOB_LOGIN_EMAIL PLAYWRIGHT_ADMIN_ORG1_EMAIL PLAYWRIGHT_ADMIN_EMAIL
set_if_missing_chain PLAYWRIGHT_BOB_PASSWORD BOB_LOGIN_PASSWORD PLAYWRIGHT_ADMIN_ORG1_PASSWORD PLAYWRIGHT_ADMIN_PASSWORD
