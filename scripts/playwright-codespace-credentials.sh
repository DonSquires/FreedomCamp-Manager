...
set_if_missing_chain PLAYWRIGHT_MASTER_EMAIL TEST_MASTER_EMAIL E2E_MASTER_EMAIL PLAYWRIGHT_GRANDMASTER_EMAIL TEST_GRANDMASTER_EMAIL E2E_GRANDMASTER_EMAIL API_TEST_EMAIL
set_if_missing_chain PLAYWRIGHT_MASTER_PASSWORD TEST_MASTER_PASSWORD E2E_MASTER_PASSWORD PLAYWRIGHT_GRANDMASTER_PASSWORD TEST_GRANDMASTER_PASSWORD E2E_GRANDMASTER_PASSWORD API_TEST_PASSWORD
