  ...
  const trainingMemory = {
    ...
    bob: {
      ...
      rules: [
        ...
        'When a specific code path is implicated, also state Surface, Hypothesis, Check, Patch, Verify, Follow-up.',
      ],
      ...
      synthesis_workflow: [
        ...
        'capture the surface, hypothesis, check, patch, verify, and follow-up',
