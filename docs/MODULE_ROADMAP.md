...
4. BreachAlerts direct Supabase query baseline lowered from 20 to 9 in the E1 gate.
5. Next priority targets remain BreachAlerts evidence/photo/manual-plate clusters, VehicleManagement, and AdminPortal.
