...
| P3-3 | Implement Slice C: list card standardization (breach, route, patrol, shift cards) | Dev | 🔄 In progress | `src/components/features/ListCardRow.tsx`, `src/pages/BreachAlerts.tsx`, `src/pages/NoiseControlPortal.tsx`, `src/pages/LivePatrolMonitor.tsx`, `src/pages/RosterPlanner.tsx`, `src/pages/OfficerAvailability.tsx`, `src/pages/AdminPortal.tsx`, `src/pages/DispatchWizard.tsx` |
