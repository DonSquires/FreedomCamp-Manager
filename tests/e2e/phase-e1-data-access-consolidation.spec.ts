...
const PHASE_E1_TARGETS: PhaseE1Target[] = [
  ...
  { page: 'BreachAlerts', baselineDirectSupabaseFromCalls: 6, reductionTarget: 'Continue reducing by moving remaining observation evidence reads into breach hooks/services.' },
