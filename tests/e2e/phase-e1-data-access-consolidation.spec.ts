...
const PHASE_E1_TARGETS: PhaseE1Target[] = [
  ...
  { page: 'BreachAlerts', baselineDirectSupabaseFromCalls: 12, reductionTarget: 'Continue reducing by moving alert queue and evidence reads into breach hooks/services.' },
