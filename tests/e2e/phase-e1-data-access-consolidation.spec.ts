...
const PHASE_E1_TARGETS: PhaseE1Target[] = [
  ...
  { page: 'BreachAlerts', baselineDirectSupabaseFromCalls: 8, reductionTarget: 'Continue reducing by moving remaining evidence and detail reads into breach hooks/services.' },
