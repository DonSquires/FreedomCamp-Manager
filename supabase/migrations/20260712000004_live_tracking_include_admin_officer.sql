-- =============================================================================
-- Live tracking: include admin_officer role
-- Date: 2026-07-12
--
-- Why:
--   get_live_officer_locations currently filters role='officer', which hides
--   admin_officer users from the live dashboard even though they are operational.
--
-- What:
--   Replace role filter with role IN ('officer', 'admin_officer') while keeping
--   org-scoping and security-definer behavior unchanged.
-- =============================================================================
