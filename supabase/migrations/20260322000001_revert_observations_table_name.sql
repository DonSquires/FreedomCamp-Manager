...
--
-- Goal:
--   Rename public.vehicle_observations_v2 -> public.observations (if needed).
--
-- Scope:
...
BEGIN
  ...
  ELSE
    RAISE NOTICE 'Neither public.vehicle_observations_v2 nor public.observations exists; skipping.';
  END IF;
END;
$$;
