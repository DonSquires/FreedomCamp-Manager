 ...
 *   SMTP_FROM_NAME     Display name (defaults to "FreedomCamp Manager – Do Not Reply")
 *
 * Request body:
...
serve(async (req) => {
  ...
  try {
    ...
    const smtpFromName = Deno.env.get('SMTP_FROM_NAME') ?? 'FreedomCamp Manager – Do Not Reply';
        ...
        <tr>
          <td style="background:#f8fafc;padding:20px 40px;text-align:center;border-top:1px solid #e2e8f0;">
            <p style="margin:0;font-size:12px;color:#64748b;">
              Generated by <strong>FreedomCamp Manager</strong> on ${escapeHtml(formatDateNZ(new Date().toISOString()))}
            </p>
