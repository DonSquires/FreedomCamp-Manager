...
<body>
  <div class="header">
    ...
    <div class="subtitle">Compliance Analytics &amp; Executive Summary &mdash; FreedomCamp Manager</div>
  ...
  <div class="footer">
    <p><strong>FreedomCamp Manager</strong> - Leadership Pack</p>
  ...
  <div style="margin-top:24px;padding-top:8px;border-top:1px solid #e2e8f0;display:flex;justify-content:space-between;align-items:center;">
    <span style="font-size:8pt;color:#94a3b8;">Generated by <strong style="color:#1e3a8a;">FreedomCamp Manager</strong> &mdash; Iron Eagle Security</span>
